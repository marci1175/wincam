...
//             IMFActivate, IMFAttributes, IMFMediaSource, IMFSample, IMFSourceReader, MEStreamTick,
//             MFCreateAttributes, MFCreateMediaType, MFCreateSourceReaderFromMediaSource,
//             MFCreateSourceReaderFromURL, MFEnumDeviceSources, MFMediaType_Video, MFShutdown,
//             MFStartup, MFVideoFormat_H265, MFVideoFormat_RGB32, MFSTARTUP_FULL,
...
//             MF_SOURCE_READER_CONTROLF_DRAIN, MF_SOURCE_READER_CURRENT_TYPE_INDEX,
...
// fn has_flag(flag: u32, check_for: u32) -> bool {
//     if flag & check_for != 0 {
//         true
//     } else {
//         false
...
//         )?;
//         attributes.SetUINT64(&MF_MT_FRAME_SIZE, (1920 << 32) | 1080)?;
...
//         let reader = MFCreateSourceReaderFromMediaSource(
//             &device.clone().unwrap().ActivateObject::<IMFMediaSource>()?,
//             &attributes,
//         )?;
...
//         media_type.SetUINT64(&MF_MT_FRAME_SIZE, (1920 << 32) | 1080)?;
...
//             dbg!(last_sample_data.len());

//             if has_flag(flags, MF_SOURCE_READERF_STREAMTICK.0 as u32) {
...
//             if has_flag(
//                 flags,
//                 windows::Win32::Media::MediaFoundation::MF_SOURCE_READERF_ENDOFSTREAM.0 as u32,
//             ) {
